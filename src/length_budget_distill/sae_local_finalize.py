...
def preview(config):
    ...
    doc=ROOT/'docs/experiments/phase6/phase6_local_length_controlled_strength_report_zh.md'
...
def finish(config):
    ...
    outputs=[doc,ROOT/'docs/presentations/sae_representation_one_slide_en.md',exposure_output,examples_output,*figures,*[t[0] for t in tests],root/'TEACHER_DECISION.json',root/'MATCHED_CONTROL_DECISION.json',
