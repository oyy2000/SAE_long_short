...
NCSU_JOB_USER="$(id -un)"
export TMPDIR="/share/jekml/${NCSU_JOB_USER}/tmp/${NCSU_JOB_USER}-ncsu-intervention-${SLURM_JOB_ID}"
...
"$SFT_PYTHON" "$CODE_ROOT/scripts/4_40_ncsu_intervention_student.py" "$@" --config "$CONFIG"
